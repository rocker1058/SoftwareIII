...
namespace MVC.Controllers
{
    public class AdministradorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CedulaA,Nombres,Apellidos,Correo,Contraseña,Telefono,Direccion")] Administrador administrador)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CedulaA,Nombres,Apellidos,Correo,Contraseña,Telefono,Direccion")] Administrador administrador)
        {
            if (ModelState.IsValid)
            {
